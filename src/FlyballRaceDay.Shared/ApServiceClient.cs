...
namespace FlyballRaceDay.Shared
{
    ...
    public partial class ApiServiceClient 
    {
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<RaceView>> ScheduleAsync(int tournamentId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("race/schedule/{tournamentId}");
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<RaceView>> UpcomingAsync(int tournamentId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("race/upcoming/{tournamentId}");
            urlBuilder_.Replace("{tournamentId}", System.Uri.EscapeDataString(ConvertToString(tournamentId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task DoneAsync(int raceId)
        {
            return DoneAsync(raceId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task DoneAsync(int raceId, System.Threading.CancellationToken cancellationToken)
        {
            if (raceId == null)
                throw new System.ArgumentNullException("raceId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("race/{raceId}/done");
            urlBuilder_.Replace("{raceId}", System.Uri.EscapeDataString(ConvertToString(raceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task RaceDELETEAsync(int raceId)
        {
            return RaceDELETEAsync(raceId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task RaceDELETEAsync(int raceId, System.Threading.CancellationToken cancellationToken)
        {
            if (raceId == null)
                throw new System.ArgumentNullException("raceId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("race/{raceId}");
            urlBuilder_.Replace("{raceId}", System.Uri.EscapeDataString(ConvertToString(raceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task RacePUTAsync(int raceId, int ringId)
        {
            return RacePUTAsync(raceId, ringId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task RacePUTAsync(int raceId, int ringId, System.Threading.CancellationToken cancellationToken)
        {
            if (raceId == null)
                throw new System.ArgumentNullException("raceId");

            if (ringId == null)
                throw new System.ArgumentNullException("ringId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("race/{raceId}/{ringId}");
            urlBuilder_.Replace("{raceId}", System.Uri.EscapeDataString(ConvertToString(raceId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{ringId}", System.Uri.EscapeDataString(ConvertToString(ringId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task RingDELETEAsync(int id)
        {
            return RingDELETEAsync(id, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task RingDELETEAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<RingView>> GetRingsAsync(int tournamentId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("ring/{tournamentId}/GetRings");
            urlBuilder_.Replace("{tournamentId}", System.Uri.EscapeDataString(ConvertToString(tournamentId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<TournamentView>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public virtual async System.Threading.Tasks.Task<TournamentView> TournamentGETAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("tournament/{id}");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
